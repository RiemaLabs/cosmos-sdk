...
type MsgCreateValidator struct {
	...
	// @nubit: Use delegator_address again because the delegator_address is taproot address to pay fee.
...
type MsgEditValidator struct {
	...
	// REF: #2373
	CommissionRate    *cosmossdk_io_math.LegacyDec `protobuf:"bytes,4,opt,name=commission_rate,json=commissionRate,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"commission_rate,omitempty"`
	MinSelfDelegation *cosmossdk_io_math.Int       `protobuf:"bytes,5,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=cosmossdk.io/math.Int" json:"min_self_delegation,omitempty"`
}
...
var fileDescriptor_0926ef28816b35ab = []byte{
	...
	,
}

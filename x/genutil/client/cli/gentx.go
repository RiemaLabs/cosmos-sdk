...
func GenTxCmd(mbm module.BasicManager, txEncCfg client.TxEncodingConfig, genBalIterator types.GenesisBalancesIterator, defaultNodeHome string, valAdddressCodec, addressCodec address.Codec) *cobra.Command {
...
`, defaultsDesc, version.AppName,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			txBldr, msg, err := cli.BuildCreateValidatorMsg(clientCtx, createValCfg, txFactory, true, valAdddressCodec, addressCodec)
			if err != nil {

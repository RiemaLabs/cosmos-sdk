...
func TestGetSigners(t *testing.T) {
	...
	var addr1 = []byte{
		0x12, 0xf3, 0xae, 0x9b, 0xd3, 0xc1, 0xe8, 0x0a,
		0x54, 0x0e, 0xb2, 0x74, 0x8b, 0x96, 0x74, 0xd7,
		0xa8, 0xc7, 0x4b, 0x9d, 0xe5, 0x28, 0xb4, 0x17,
		0x3e, 0x7d, 0xe5, 0xc8, 0xf9, 0x67, 0x21, 0xcb,
	}

	var addr2 = []byte{
		0x9a, 0x8d, 0x76, 0xb3, 0xc6, 0x2e, 0x49, 0xe5,
		0x38, 0xe2, 0xb7, 0xc3, 0xfe, 0x70, 0xa0, 0xc6,
		0x7c, 0x42, 0x99, 0x2c, 0xf7, 0x68, 0x2e, 0x6f,
		0x8e, 0xd0, 0x21, 0x1b, 0x71, 0xd4, 0x97, 0x65,
	}
	require.NoError(t, err)
	cdc := codec.NewProtoCodec(interfaceRegistry)
	testAddr := sdk.AccAddress(addr1)
	testAddrStr := testAddr.String()
	testAddr2 := sdk.AccAddress(addr2)
